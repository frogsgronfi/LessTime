...
##############################################################################
 ...
 ## If you want to solve the model using --minisat, comment the objective function above and uncomment the one below:
 maximize obj:
  sum{c in Courses, d in Days, s in Slots, r in Rooms} schedule[c,r,d,s];
